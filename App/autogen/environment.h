...
Q_IMPORT_QML_PLUGIN(FlightSimContentPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_ElolapPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_KerekPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_FlapPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_Flap2Plugin)
Q_IMPORT_QML_PLUGIN(FlightSimPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/FlightSimContent/App.qml";
